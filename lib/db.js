...
export const IN_MEMORY_DB = {
    ...
    social_configs: [
        {
            channel_id: "105678912345678",
            platform: "facebook",
            channel_name: "Thai Watsadu Official",
            config: {
                pageId: "105678912345678",
                appSecret: "mock_app_secret",
                accessToken: "EAAGm0PX4ZC...mock...token",
                verifyToken: "stk_fb_verify_2026",
                pageName: "Thai Watsadu Official"
            }
        },
        {
            channel_id: "1654321987",
            platform: "line",
            channel_name: "LINE OA Official",
            config: {
                channelId: "1654321987",
                channelSecret: "ab12cd34ef56gh78ij90kl12mn34op56",
                accessToken: "eyJhbGciOiJIUzI1NiJ...mock...token"
            }
        }
    ]
};
...
try {
    ...
    } else if (process.env.DB_PASSWORD && process.env.DB_PASSWORD !== 'your_secure_password') {
        dbPool = new Pool({
